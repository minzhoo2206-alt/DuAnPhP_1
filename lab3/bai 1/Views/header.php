...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        h2 { color: #2c3e50; border-bottom: 2px solid #1abc9c; padding-bottom: 8px; margin-bottom: 15px; }
    </style>
</head>
<body>
<header>
    <h1>MyShop</h1>
    <nav>
        <?php $current = $_GET['action'] ?? 'home'; ?>
        <a href="index.php?action=home"    class="<?= $current === 'home'    ? 'active' : '' ?>">Trang chủ</a>
        <a href="index.php?action=product" class="<?= $current === 'product' ? 'active' : '' ?>">Sản phẩm</a>
    </nav>
</header>
<main>
